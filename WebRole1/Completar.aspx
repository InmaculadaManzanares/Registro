<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" codeBehind="Completar.aspx.vb" Inherits="NuevaPlantilla.Completar" title="Completar Registros" %>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:TextBox ID="txthora1" required="true" type="text" runat="server" CssClass="form-control pq"></asp:TextBox>
                                </div>
                               <div class="col-md-2">
                                    <label>Hora Fin</label>
                                    <asp:TextBox ID="txthora2" required="true" type="text" runat="server" CssClass="form-control pq"></asp:TextBox>
                                </div>
                                <div class="col-md-2">
                                    <label>Lugar</label>
                                    <asp:TextBox ID="lugar" Text="Oficina" required="true" type="text" runat="server" CssClass="form-control pq"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="form-horizontal">
                ...
                <div class="col-sm-12">
                    ...
                    <asp:Panel ID="panelresultado" Visible="false" runat="server">
                        ...
                        <div role="tabpanel" id="myTab">
                            ...
                            <asp:Button ID="Completar" formnovalidate runat="server" CausesValidation="False" OnClientClick="javascript:return confirm('¿Está seguro que desea completar el registro? Compruebe los fultros');" Text="Completar Registros" class="btn btn-success-docBox" />

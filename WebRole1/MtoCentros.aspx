<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" codeBehind="MtoCentros.aspx.vb" Inherits="NuevaPlantilla.MtoCentros" title="Centros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ocultarpanel(id_panel) {
            // Ocultamos el panel detalleMtoCentrosMtoCentros
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="form-inline">
                            ...
                            <asp:LinkButton ID="nuevo"
                                    runat="server"
                                    CssClass="btn btn-success-docBox"> <i class="glyphicon glyphicon-plus"></i>Nuevo Centro</asp:LinkButton>
                             ...
                             <div class="tab-pane" id="detalle">                                
                                <div class="row" style="padding-top: 10px;">
                                    <div id="lg" class="form-horizontal">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label pq">nombre</label>
                                                <div class="col-md-8">

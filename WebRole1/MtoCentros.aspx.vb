...
Partial Class MtoCentros
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                borra_campos()
                filtro()
                cargacombo_campos("SELECT  Id,Nombre  FROM  Centros", combo_campo)
                Dim texttitulo As Label = DirectCast(Page.Master.FindControl("titulo"), Label)
                texttitulo.Text = "Centros"
    ...
    Protected Sub CargaMatriz(ByVal cond_filtro As String)
        ...
        cadena = "SELECT  Id,  Nombre FROM  Centros"
        If cond_filtro <> "" Then
        ...
        If txtid.Text = "" Then
            Try
                ...
                If nombre = VACIO Then
                    ...
                    msj_alerta = "El centro se ha guardado correctamente."
                    mostraralerta()
                    ...
                    resul = True
                Else
                    msj_alerta = "El centro ya existe"
                    mostraralerta()
            ...
            Catch ex As Exception
                ...
                msj_alerta = "Error insertando centro: " & ex.Message
                mostraralerta()
                resul = False
            Finally
                If Not con Is Nothing Then

<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" codeBehind="MtoEmpresas.aspx.vb" Inherits="NuevaPlantilla.MtoEmpresas" title="Empresas" %>
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="form-inline">
                            ...
                            <asp:LinkButton ID="nuevo"
                                    runat="server"
                                    CssClass="btn btn-success-docBox"> <i class="glyphicon glyphicon-plus"></i>Nueva Empresa </asp:LinkButton>

<%@ Page Language="VB" MasterPageFile="~/PaginaPrincipal.master" AutoEventWireup="false" codeBehind="MtoRegistro.aspx.vb" Inherits="NuevaPlantilla.MtoRegistro" title="Vacaciones/Bajas" %>
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        ...
                                        <asp:GridView ID="matriz" runat="server" CssClass="table table-hover table-condensed" GridLines="None" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDS">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Oficina" HeaderText="Vacaciones/Baja" SortExpression="Oficina">
                                                <ItemStyle />
                                                </asp:BoundField>
                             ...
                             <div class="tab-pane" id="detalle">                                
                                <div class="row" style="padding-top: 10px;">
                                    <div id="lg" class="form-horizontal">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label pq">Fecha Inicio</label>
                                                <div class="col-md-3">
                                                 ...
                                                 <asp:label runat="server" ID="lbldias" CssClass ="col-md-2 control-label pq">Nº de Días</asp:label>
                                                <div class="col-md-3">
                                                    <asp:TextBox ID="txtdias" required="true" type="text" runat="server" CssClass="form-control pq"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-8">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label pq">Situación</label>
                                                <div class="col-md-3">
                                                    <asp:DropDownList ID="cmbmotivo" AutoPostBack="true" required="true"  runat="server" CssClass="form-control pq">
                                                          <asp:ListItem Value=""></asp:ListItem>
                                       ...
                                       <div class="col-sm-12 col-lg-8">
                                            <div class="form-group">
                                                  <label class="col-md-4 control-label pq"></label>
                                                <div class="col-md-4">
                                                    <asp:checkbox ID="sabadodomingo"  runat="server" Text="&nbsp;&nbsp;Incluir Sabados y Domingos" Checked ="false"   ></asp:checkbox>
                                                </div>
                                                </div>
                                           </div>
                                      <div class="col-sm-12 col-lg-8">
                                            <div class="form-group">
                                                  <label class="col-md-4 control-label pq"></label>
                                                <div class="col-md-4">
                                                    <asp:checkbox ID="festivos"  runat="server" Text="&nbsp;&nbsp;Incluir Festivos" Checked ="false"  ></asp:checkbox>
                                                </div>
                                            </div>
                                        </div>  
